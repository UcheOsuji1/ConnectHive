...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (oauthError) {
      const messages = {
        oauth_state_mismatch: 'Sign-in was interrupted — please try again.',
      ...
      <div className="si-right">
        ...
        <div className="si-form-inner">
          ...
          {config?.googleSignIn && (
            <>
              <div className="si-oauth-row">
                <button
                  className="si-oauth si-oauth--full"
                  type="button"
                  onClick={() => {
          ...
          <div className="si-row">
            ...
            <button type="button" className="si-forgot" onClick={() => navigate('/forgot-password')}>Forgot password?</button>
          </div>
